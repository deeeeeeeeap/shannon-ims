...
// satisfies messaging.Service behind runtimehost.Instance's capability seam.
// Keep them fail-closed rather than pretending success: unlike the SMS path,
// no spike has validated a USSD-over-SIP flow yet.
